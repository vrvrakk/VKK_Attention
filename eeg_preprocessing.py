...
subject_dir = eeg_dir / 's1'  / 'll' / 'azimuth'
output_dir = eeg_dir / ''
...
#             # collect header files
            header_files = list(subject_dir.glob('*.vhdr'))
            raws = []
            # concatenate blocks
            ...
            raw = raw.filter(l_freq=.5, h_freq=None, phase="minimum") # everything below 0.5Hz (electromagnetic drift)
