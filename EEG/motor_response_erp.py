...
from EEG.epochs_categories import exceptions, event_types, conditions, channels
...
if __name__ == '__main__':
    ...
    for event_type in all_concat_epoch_types.keys():
        ...
        if epochs_info:  # Ensure there is data
            ...
            merged_epochs.filter(l_freq=None, h_freq=12)  # Keep frequencies below 8 Hz
            ...
            erp.plot(titles=titles, gfp=True, picks=['C3', 'C4'])

            freqs = np.logspace(np.log10(1), np.log10(12), num=150)  # 25 log-spaced frequencies
            ...
            power.plot(picks=picks[0], baseline=(-0.2, 0), mode='logratio',
